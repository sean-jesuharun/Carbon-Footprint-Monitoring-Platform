...
export default function Dashboard({ darkMode }) {
  const [columns] = useState([
    { field: 'Carbon_Emission_Job_Name', headerName: 'Carbon_Emission_Job_Name', width: 300,headerAlign: 'center', align: 'center' },
    { field: 'Customer', headerName: 'Customer', width: 150,headerAlign: 'center', align: 'center' },
    { field: 'Vehicle', headerName: 'Vehicle', width: 130,headerAlign: 'center', align: 'center' },
  ...
  const rows = [
    { id: 1, Carbon_Emission_Job_Name: 'Kamal', Customer: 'ABC123', Vehicle: 'Premier Gasoline', Products_Details: '10.25'},

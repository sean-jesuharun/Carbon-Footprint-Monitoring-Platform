...
export default function Customertable({ darkMode }) {
  const [columns] = useState([
    { field: 'Customer_name', headerName: 'Customer_name', width: 200,headerAlign: 'center', align: 'center' },
    { field: 'Customer_location', headerName: 'Customer_location', width: 150,headerAlign: 'center', align: 'center' },
    { field: 'Distance_from_Sysco', headerName: 'Distance_from_Sysco', width:250,headerAlign: 'center', align: 'center' },

package org.cfms.vendorservicecfms.exception.controllerAdvice;

import org.cfms.vendorservicecfms.controller.AbstractController;
...
import org.cfms.vendorservicecfms.exception.model.ErrorResponse;
...
public class GlobalExceptionHandler extends AbstractController {
    ...
    public ResponseEntity<Object> handleVehicleNotFoundException(VendorNotFoundException ex) {
    ...
    public ResponseEntity<Object> handleVendorProductNotFoundException(VendorProductNotFoundException ex) {

...
public class TransportationController {
    ...
    public ResponseEntity<String> transportationDataProcess(@PathVariable("vehicle_id") Long vehicle_id, @PathVariable("transport_inventory") String transportInventory, @PathVariable(value = "vendor_id", required = false) Long vendor_id, @RequestBody Transportation transportation){
